...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_post.html', form = form, title = 'Flask Blog -- New Post', legend = 'New Post')
...
def post(post_id):
    ...
    return render_template('post.html', title = 'Flask Blog -- '+post.title, post = post)
...
def update_post(post_id):
    ...
    return render_template('create_post.html', form = form, title = 'Flask Blog -- Update('+post.title+')', post = post, legend = 'Update Post')
